...
```
Agent(
  prompt="Read C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/templates/VALIDATION.md`
