...
```bash
INIT=$(node "C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/templates/spec.md.
