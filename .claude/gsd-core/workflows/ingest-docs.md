...
```bash
INIT=$(node "C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/bin/gsd-tools.cjs" commit \
