...
INSTALL_JS_GLOBAL="C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
