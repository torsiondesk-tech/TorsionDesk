...
- Usage: Reference from command with `@C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/marco/Desktop/HOME SERVICE CRM/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
