...
- [ ] **Phase 0: Foundation — Tenancy, Auth, and Data Spine** - Workspace creation, Clerk native auth, role-based access, and RLS tenant isolation
- [ ] **Phase 1: Customers, Locations, and Equipment** - Customer book with contacts, service locations, and per-location equipment/spring specs
