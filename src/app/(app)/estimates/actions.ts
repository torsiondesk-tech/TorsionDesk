      ...
      const id = await withTenant(orgId, async (tx) => {
        ...
        const [row] = await tx
          ...
          .values({
            ...
            arrivalWindowStart: d.arrivalWindowStart ? new Date(`1970-01-01T${d.arrivalWindowStart}:00Z`) : null,
            arrivalWindowEnd: d.arrivalWindowEnd ? new Date(`1970-01-01T${d.arrivalWindowEnd}:00Z`) : null,
